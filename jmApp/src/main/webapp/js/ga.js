...
(function () {
    ...
    dywe.src = '/scripts/zhaopin/dywe.js';
...
function recordOutboundLink(link, category, action) {
    ...
    try {
        ...
        i.src = "https://passport.zhaopin.com/track_err.gif?dywee=5(" + category + "*" + action + ")&dywehn=" + ed(e.hostname) + "&dywep=" + ed(e.pathname + e.search, true);
    }
}
function dyweTrackEvent(category, action) {
    ...
    try {
        ...
        var i = new Image(1, 1);
        var e = document.location;
        i.src = "https://passport.zhaopin.com/track_err.gif?dywee=5(" + category + "*"
