...
<body>
	...
	<div style="margin-top:100px;margin-left:60px; margin-right:100px;"
		id="lib_Tab1_sx" class="lib_tabborder_sx">
		<div class="col-md-2"
			style="border-right: solid 2px #e9e9e9;font-size: 18px;">
			<ul class="nav nav-pills nav-stacked" role="tablist"
				style="text-align: center;">
				<li id="one1" name="1" role="presentation" class="active" onclick="setTab('one',1,4)"
	...
	<div class="lib_Contentbox_sx ">
		<div id="con_one_1">
			<div align=center>
				...
				<h4>
					...
					<font face="Viner Hand ITC"><br> The ones who see
						things differently.<br></font> <font face="方正舒体"><br>
						...
						你可以引用他们，也可以否决他们，质疑他们，颂扬抑或是诋毁他们<br></font> <font
						face="Viner Hand ITC"><br> You can quote them,
						disagree with them,disbelieve them, glorify or vilify them.<br></font>
					<font face="方正舒体"><br> 但唯独不能漠视他们<br></font> <font
						face="Viner Hand ITC"><br> About the only thing that
						you can’t do, is ignore them.<br></font> <font face="方正舒体"><br>
						...
						They explore. They create. They inspire.<br></font> <font
						face="方正舒体"><br> 他们让人类向前跨了一大步<br></font> <font
						face="Viner Hand ITC"><br> They push the human race
						forward.<br></font> <font face="方正舒体"><br> 也许他们是被迫成疯<br></font>
					<font face="Viner Hand ITC"><br> Maybe they have to be
						crazy.<br></font> <font face="方正舒体"><br>
					...
					<p>&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;每一段故事都有开头与结尾，我们注重的是从零到一，从一而终的过程
						如果你也正好是一个不安于现状，特立独行的人，想要改变些什么联系我们， 用你认识世界的独特方法，坦然地去推动周遭的改变</p>
		...
		<div id="con_one_2" style="display:none">
			...
			用户的每一次支持，都是我们最珍视的，所以除了创意，你们还需要拿出诚意，除了用心，还要愿意付出真心。 希望你们在这里开启一段不一样的旅程。<br>
			<br> 这里能为你做什么<br> &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
			...
			接下来，还有几件非常重要的事情，直接关乎众筹的成败。<br> 设置支持金额与回报<br> &nbsp;
			&nbsp;&nbsp; &nbsp;&nbsp;
			...
			提交项目<br> 现在你对众筹过程已经有了清晰的了解，可以提交项目资料了。<br> 如何提交<br>
			•注册并登录91九马众筹账号<br> •点击官网首页右上角的“发起项目”<br> •填写完整信息后“存为草稿”<br>
			•点击页面顶端“提交审核”<br> 审核须知<br> &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
		...
		<div id="con_one_3" style="display:none">
			<div align=center>
				<h2>91九马众筹用户注册服务协议</h2>
			</div>
			<br>
			<br> 第一条 签约主体与特别声明<br>
			<p>
				&nbsp; &nbsp;&nbsp; &nbsp;1.1
				91九马众筹平台（以下简称“本平台”）是由杭州玖壹玖马网络科技有限公司开发、运营的网络平台，为保护支持者的合法权益，规范发起人的行为，维护本平台的秩序，特拟定《91九马众筹用户注册服务协议》（以下简称“本协议”）。<br>
				&nbsp; &nbsp;&nbsp;
				...
				&nbsp; &nbsp;&nbsp; &nbsp;1.3
				您应是具有完全民事权利能力和民事行为能力的自然人，或依法设立并有效存续的单位（包括企业法人及其他组织）。<br> &nbsp;
				&nbsp;&nbsp;
			...
			第二条遵守法律<br> &nbsp; &nbsp;&nbsp; &nbsp;2.1
			当使用本平台服务时，用户同意遵守中华人民共和国相关法律法规，包括但不限于《中华人民共和国宪法》、《中华人民共和国合同法》、《中华人民共和国电信条例》、《互联网信息服务管理办法》、《互联网电子公告服务管理规定》、《中华人民共和国保守国家秘密法》、《全国人民代表大会常务委员会关于维护互联网安全的决定》、《中华人民共和国计算机信息系统安全保护条例》、《计算机信息网络国际联网安全保护管理办法》、《中华人民共和国著作权法》及其实施条例、《互联网著作权法行政保护办法》等。用户只有在同意遵守所有相关法律法规和本协议时，才有权使用本平台服务。<br>
			第三条 用户账号和使用规范<br> &nbsp; &nbsp;&nbsp; &nbsp;3.1
			用户注册时应按本平台注册页面提示填写真实、准确、有效的信息，不得侵害他人的利益，否则自行承担由此引起的全部责任及后果，平台保留终止其使用各项服务的权利。完成注册程序后，即成为注册用户，有权享有平台提供的服务。<br>
			&nbsp; &nbsp;&nbsp; &nbsp;3.2
			用户不应该将其账号、密码转让、出借或告知他人，供他人使用。如用户发现账号遭他人非法使用，应立即通知本平台，以避免造成可能的损失。<br>
			&nbsp; &nbsp;&nbsp; &nbsp;3.3
			本平台为更好地保护您的合法权益并向您提供优质、高效的服务，本平台可能将您的信息应用在以下方面：<br>
			（1）在您登录本平台时进行必要的身份验证；<br> （2）根据您的浏览记录及相关信息，向您推荐您可能感兴趣的众筹项目资料；<br>
			...
			&nbsp;&nbsp; &nbsp;3.4
			当您使用本平台服务时，必须遵守中华人民共和国相关法律法规的规定，用户保证不会利用本平台进行任何违法或不正当的活动，包括但不限于下列行为：<br>
			（1）违反本协议的规定；<br> （2）冒用他人名义使用本服务；<br> （3）利用本服务侵害他人的合法权益；<br>
			（4）从事非法交易；<br> （5）反对宪法及其他法律的基本原则，危害国家安全，泄露国家秘密，颠覆国家政权，破坏国家统一；<br>
			（6）散布谣言，扰乱社会秩序，破坏社会稳定的；<br> （7）散步淫秽、色情、赌博、暴力、凶杀、恐怖或者教唆犯罪的；<br>
			...
			（1）本平台公告系统停机维护期间；<br> （2）电信设备出现故障不能进行数据传输；<br>
			...
			<br> 第五条 隐私权保护<br> &nbsp; &nbsp;&nbsp; &nbsp;5.1
			当您在本平台注册并参与平台互动项目时，平台服务器将记录您的信息与操作，请您予以接受并充分理解。<br> &nbsp;
			&nbsp;&nbsp; &nbsp;5.2
			本平台不会将您的个人信息和资料予以泄露，但是根据下列情况，平台有权全部或部分披露您的个人信息： <br>
			...
			（5）您出现违反本平台网站规则，需要向第三方披露的； <br> （6）根据本平台网站公示规则，需要披露的。<br>
			第六条 发起者和支持者之间的合同关系<br> &nbsp; &nbsp;&nbsp; &nbsp; 6.1
			91九马众筹为众筹项目提供融资平台。当发起者发起众筹项目，支持者付款支持后，发起者与支持者之间就形成了合同关系：支持者接受发起者的提议，并形成合同。<br>
			&nbsp; &nbsp;&nbsp; &nbsp; 6.2
			91九马众筹并不是这个合同的一部分。合同只有双方，发起者和支持者。但这份合同包括以下定式条款：<br>
			...
			如果该协议发生修改，本平台有义务通过电子邮件或其他联系方式通知你，或在平台显著位置发布通知。<br>
			<br>
			<br>
			<br>
			<br>
		...
		<div id="con_one_4" style="display:none">
			...
			<br>
			<br> &nbsp; &nbsp; &nbsp;
			&nbsp;投资人对项目方和平台的信任与支持是我们最宝贵的财富，所以为了更加高效而顺利地完成整个众筹过程，我们必须遵循一些最基本的原则，平台也会尽最大努力为项目方及支持者提供整套安全、透明、高效的运作机制，来保障众筹活动中各方的基本权益。<br>
			<br>
			<b>我们的原则</b><br>
			<br>信息真实原则<br>&nbsp; &nbsp; &nbsp;
			&nbsp;普通用户与项目发起人应遵循信息的真实性原则，所填写与发布的信息应尽可能详尽、具体和准确。<br> 自愿共赢原则<br>
			&nbsp; &nbsp; &nbsp;
			&nbsp;投资人在平台所做的投资属于个人意愿，平台承担部分众筹时期的风险控制功能，但项目的经营管理结果，平台不负最终责任，项目发起方作为融资者，需要更大的耐心与责任，积极沟通，并主动披露运营结果，按时发放约定回报等，以获得投资者的信任。<br>
			风险共担原则<br> &nbsp; &nbsp; &nbsp;
			&nbsp;从投资人实际支持项目开始，投资人和项目发起人就已经成了项目的共同经营者，不仅利益共享，同时风险也共担<br>
			<br> <b>保障机制</b><br>
			<br> 身份认证体系<br> &nbsp; &nbsp; &nbsp;
